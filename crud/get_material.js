function ver_material() {
    ...
    request.onload = () => {
        ...
        if (request.status === 401 || request.status === 403) {
            ...
            btn_actualizar.innerHTML    = '<br><br><br><br><br><br><br><a href="/MaterialesRegistrados.github.io/update_material.html?' + id + '" class="btn btn-success btn-block btn-lg">Actualizar</a>';
            ...
            btn_regresar.innerHTML      = '<br><br><br><br><br><br><br><a href="/MaterialesRegistrados.github.io/materiales.html" class="btn btn-primary btn-block btn-lg">Regresar</a>';
            ...
            Swal.fire({
                ...
                window.location = "/MaterialesRegistrados.github.io/index.html";
            }
            );
        }
    }
